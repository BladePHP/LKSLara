...
<?php $__env->startSection('body'); ?>
    ...
    <div class="mb-3 justify-content-between align-item-center d-flex">
        ...
        <a href="<?php echo e(route('create')); ?>" class="btn btn-primary">Tambah Keluhan</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="align-center">
                        <div class="btn btn-group">
                            <a href="<?php echo e(route('edit', $sw->id)); ?>" class="btn btn-primary">Edit</a>
                            <a href="<?php echo e(route('show', $sw->id)); ?>" class="btn btn-secondary">Show</a>
                            <a href="<?php echo e(route('balasan', $sw->id)); ?>" class="btn btn-warning">Balasan</a>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Desktop\final\resources\views/keluh/siswa.blade.php ENDPATH**/ ?>